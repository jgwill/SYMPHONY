...
export { default as FileTreePanel } from './FileTreePanel'; // Export FileTreePanel
export { default as ResizablePanelsLayout } from './ResizablePanelsLayout'; // Export ResizablePanelsLayout
